         ...
         <div class="card-header">
            <div class="row">
               <div class="col-md-6">
                  ...
                  <a href="index.php?option=contact&cat=trash" class="btn btn-sm btn-warning"> Thùng rác</a>
               </div>
                        ...
                        <?php if (count($list) > 0) : ?>
                           <?php foreach ($list as $item) : ?>
                              <tr class="datarow">
                                 ...
                                 <td>
                                    <img class="img-fluid" src="../public/images/contact/<?= $item->image; ?>" alt="<?= $item->image; ?>">
                                 </td>
                                 <td>
                                    <div class="name">
                                       <?= $item->name; ?>
