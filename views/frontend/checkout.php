            ...
            <form action="index.php?option=checkout" method="post">
               ...
               <?php if (isset($_SESSION["iscustom"])) : ?>
                  ...
                  <div class="mb-3">
                     ...
                     <input type="email" name="email" id="email" value="<?= $customer->email; ?>" class="form-control" placeholder="Nhập điện thoại" readonly>
                  </div>
                  <div class="card">
               ...
               <tbody>
                  ...
                  <?php foreach ($listcart as $item) : ?>
                     ...
                     <tr>
                        ...
                        <td>
                           <img class="img-fluid" src="public/images/product/<?= $item['image']; ?>" alt="">
                        </td>
               ...
               <tfoot>
                  <tr>
                     <td colspan="6" class="text-end">
                        <strong>Tổng: <?= number_format(Cart::cartTotal()); ?>đ</strong>
                     </td>
                  </tr>
               </tfoot>
            </table>
